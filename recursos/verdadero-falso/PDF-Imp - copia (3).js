   ...
   $(document).on('click', '.check-tf', function(e) {
    ...
    if ($('input[name=truefalse1-'+ comparar +']').is(':checked')) {
      ...
      if ($('input[name=truefalse1-'+ comparar +']:checked').val() == evalua[comparar-1]) {
          ...
          $(dataActivity + '  .truefalsed1-section:nth-child(' + parseInt(comparar + 1) + ') input:radio:checked').parent().parent().append('<i class="result fa-solid fa-check">');
      } 
      else {
          mensajes=" Es incorrecto";
          $(dataActivity + '  .truefalsed1-section:nth-child(' + parseInt(comparar + 1) + ') input:radio:checked').parent().parent().append('<i class="result fa-solid fa-xmark">');
