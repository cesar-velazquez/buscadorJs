    ...
    if (bandera == ($(dataActivity + " input[type=radio]").length / 3)) {
      ...
      for (var i = 0; i < respuestas.length; i++) {
        if (respuestas[i] == evalua[i]) {
          ...
          var classtomar=$(dataActivity + ' .truefalsed1-section:nth-child(' + parseInt(i + 2) + ') input:radio:checked').parent().parent().attr("class");
          var classtomar2=$(dataActivity + ' .truefalsed1-section:nth-child(' + parseInt(i + 2) + ') input:radio:checked').parent().parent().attr("class");
